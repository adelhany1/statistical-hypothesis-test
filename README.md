...
The t-test is a method that determines whether two populations are statistically different from each other, 
                 
whereas ANOVA (Q4) determines whether three or more populations are statistically different from each other
